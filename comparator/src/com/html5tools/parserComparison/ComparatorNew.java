...
public class ComparatorNew {
	...
	public static void main(String[] args) throws Exception {
		ComparatorNew comparatorNew = new ComparatorNew();
		comparatorNew.run(args);
	}
	...
	private void updateTestResults(List<String> successfulParsers) {
		...
		for (String parserName : successfulParsers) {
			...
			String xPathExp = "/report/testResult/*[@name='" + parserName
					+ "']";
			Node parserNodeInTestResult = (Node) XMLUtils.executeXPath(report,
					xPathExp, XPathConstants.NODE);
